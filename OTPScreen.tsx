...
const OTPScreen: React.FC<OTPProps> = ({ phone, onSuccess, onBack }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#0E0E0B] px-8 pt-12 animate-in slide-in-from-right duration-500">
      ...
      <div className="mb-12">
        <h2 className="text-2xl font-black uppercase tracking-tight mb-2 text-white">Verify Phone</h2>
      ...
      <div className="space-y-10 flex-1">
        <div className="flex justify-between max-w-[280px] mx-auto relative">
          {[0, 1, 2, 3].map((i) => (
            <div 
              key={i}
            ...
            >
              <span className="text-white">{otp[i] || ''}</span>
